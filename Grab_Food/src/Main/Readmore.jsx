    ...
    <div>
      <div className={style.button_promotions}>
        {showMore && ( // Chỉ render nút nếu showMore là true
          <button onClick={handleReadMoreClick} className={style.btn_promotions}>Read more</button>
        )}
        
      </div>
      {!showMore && ( 
        <div className={style.cauhoi}>
<hr className={style.HorizontalLines_readmore} />
            <div>
